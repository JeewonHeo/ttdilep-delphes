...
#include "delphes/external/interface/Basic_Mt2_332_Calculator.h"
#include "delphes/external/interface/Mt2Units.h"
...
namespace Mt2 {
  ...
  */
  ...
  double Basic_Mt2_332_Calculator::mt2_332(const LorentzTransverseVector& visA, 
  ...
  double Basic_Mt2_332_Calculator::mt2_332_Sq(const LorentzTransverseVector& visA,
					      const LorentzTransverseVector& visB,
					      const TwoVector& ptmiss,
					      const double mEachInvisible){
  ...
  double  Basic_Mt2_332_Calculator::mT2Fcn::operator()(const std::vector<double>& par) const {
