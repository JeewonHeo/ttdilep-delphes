#ifndef DELPHYS_ANALYSIS_TTDILEPTONANALYSERV2_H_
#define DELPHYS_ANALYSIS_TTDILEPTONANALYSERV2_H_
...
class TTSemileptonAnalyser : private BaseAnalyser {
 public:
//  TTSemileptonAnalyser(const TString & in_path, const TString & out_path, bool, float, std::string, float);
  TTSemileptonAnalyser(const TString & in_path, const TString & out_path, bool, std::string, float);

  ~TTSemileptonAnalyser();
  void loop();
